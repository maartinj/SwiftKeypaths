...
struct Purchase {
    ...
    static let wineryNamePath = \Self.winery.name
}
...
code(for: "2. With KeyPaths") {
    // Print the name of the winery of the wine purchased
    let wineryNameKeyPah = \Purchase.winery.name
//    print(samplePurchase[keyPath: wineryNameKeyPah])
...
code(for: "3. Static Type KeyPath") {
    ...
    print(samplePurchase[keyPath: Purchase.wineryNamePath])
}
